...
bar_chart <- 
  function(label, width = "100%", height = "0.875rem", fill = "#00bfc4", background = NULL) {
    ...
    columns = list(
      ...
      proportion = colDef(
        ...
        cell = function(value) {
          ...
          bar_chart(value, width = value, fill = "#4f79a7", background = "#e1e1e1")
        },
        align = "left",
...
median <- median(df$Délai)

p <- df %>%
  ggplot() +
  aes(x = Délai) +
  geom_histogram(binwidth = 1) +
  geom_vline(xintercept = median, col = "#FF330F", lty = "dashed") +
  annotate("text", x = median + 15, y = 2000, label = "Délai médian", size = 3, color = "#FF330F") +
  theme_classic() +
  scale_y_continuous(
...
# Publications Sorbonne Université
